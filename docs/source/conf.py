...
project = u'OpenRobotics'
copyright = u'OpenRobotics Team'
...
htmlhelp_basename = 'OpenRoboticsDocument'
...
latex_documents = [
  ('index', 'OpenRobotics.tex', u'Ceres Solver',
...
man_pages = [
    ('index', 'OpenRobotics', u'OpenRobotics',
